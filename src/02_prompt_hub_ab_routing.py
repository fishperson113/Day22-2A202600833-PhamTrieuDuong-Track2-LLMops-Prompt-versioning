...
PROMPT_V1_NAME = "phamtrieuduong-rag-prompt-v1"
PROMPT_V2_NAME = "phamtrieuduong-rag-prompt-v2"
...
SYSTEM_V1 = (
    ...
    "Nếu context không đủ, hãy nói bạn chưa có đủ thông tin từ context."
)
...
SYSTEM_V2 = (
    "Bạn là chuyên gia AI. Chỉ dùng context được cung cấp để trả lời.\n\n"
    "Context:\n{context}\n\n"
    "Hãy đọc kỹ context, chọn các facts liên quan nhất, rồi trả lời với giọng điệu "
    "chuyên gia, rõ ràng, có cấu trúc trong 3-5 câu. Nếu context thiếu dữ kiện, "
